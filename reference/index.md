...
- [`get_codelist()`](https://bennettoxford.github.io/opencodecounts/reference/get_codelist.md)
  :
...
- [`extract_semantic_tag()`](https://bennettoxford.github.io/opencodecounts/reference/extract_semantic_tag.md)
